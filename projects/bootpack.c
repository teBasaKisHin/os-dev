...
void set_gatedesc(struct GATE_DESCRITPTOR *gd, int offset, int selector, int ar);
...
void init_gdtidt(void) {
	...
	struct GATE_DESCRITPTOR	  *idt = (struct GATE_DESCRITPTOR *)    0x0026f800;
	int i;
